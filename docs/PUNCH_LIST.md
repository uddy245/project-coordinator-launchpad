...
Last reviewed: 2026-05-05 (after PR #70 — Lesson 2 grading pipeline shipped)
...
- [ ] **Lesson 3 grading pipeline** (PR #71 in flight) — sourced from Ch 3 (written voice).
- [ ] **Lesson 4 grading pipeline** (PR #72 in flight) — sourced from Ch 2 (mindset).
- [ ] **Modules M05–M07 grading pipelines** — same 5-file pattern, one per module. Source from handbook Chapters 5, 6, 7.
...
- 2026-05-05 — **PR #69** merged: Lesson 1 (coordinator-role) grading pipeline. role-understanding rubric (5 dims grounded in Ch 1), grade-role prompt with job-description-recital + jargon caps, scenario (first-week memo), 5 fixtures. Calibration green first try. Lesson 1 fully gradable.
- 2026-05-05 — **PR #70** merged: Lesson 2 (project-lifecycle) grading pipeline. lifecycle-awareness rubric (5 dims sourced from Ch 4 four-questions model), grade-lifecycle prompt with no-backward-trace + more-artifacts + generic-move caps, struggling-project diagnostic scenario, 5 fixtures including artifact_without_understanding (the central misdiagnosis the chapter warns against). 4 calibration cycles to settle. Lesson 2 fully gradable.
