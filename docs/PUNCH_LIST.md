...
**Part-I grading pipelines complete + Lesson 8 (Requirements Literacy) shipped. Lessons 1–8 are fully gradable end-to-end via the AI grading service. Calibration corpus is 65 fixtures across 8 competencies (35 risk_identification + 5 each for the other 7).**
